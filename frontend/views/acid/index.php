...
<div class="acid-index">
    ...
    <p><?= Html::a('Pie', Url::toRoute('acid/pie')) ?></p>
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (fromCoord && toCoord) {
                        res.push({
                            ...
                            classtype: dataItem[1].classtype
                        });
                    }
                }
                return res;
                    ...
                    { // 绿线箭头
                        ...
                        tooltip : {
                            ...
                            formatter: function (params, ticket, callback) {
                                ...
                                return '源IP：' + params.data.ip_src + '<br>目标IP：' + params.data.ip_dst + '<br>攻击方式：' + params.data.classtype;
                            }
